...
void test_createRequestString_playlistStatus_simple(){
    ...
    char uutCommand[150];
    char expectedRes[150];
    sprintf(expectedRes, "/youtube/v3/playlists?part=status&id=%s&key=%s", TEST_PLAYLIST_ID, API_KEY);
    YoutubeApi::createRequestString(playlistListStatus, uutCommand, TEST_PLAYLIST_ID);
...
void test_createRequestString_playlistSnippet_simple(){
    ...
    char uutCommand[150];
    char expectedRes[150];
    sprintf(expectedRes, "/youtube/v3/playlists?part=snippet&id=%s&key=%s", TEST_PLAYLIST_ID, API_KEY);
    YoutubeApi::createRequestString(playlistListSnippet, uutCommand, TEST_PLAYLIST_ID);
...
void test_createRequestString_playlistItemsContentDetails_simple(){
    ...
    char uutCommand[150];
    char expectedRes[150];
    sprintf(expectedRes, "/youtube/v3/playlistItems?part=contentDetails&playlistId=%s&key=%s", TEST_PLAYLIST_ID, API_KEY);
    YoutubeApi::createRequestString(playlistItemsListContentDetails, uutCommand, TEST_PLAYLIST_ID);
...
void setup()
{
    ...
    RUN_TEST(test_createRequestString_playlistSnippet_simple);
    RUN_TEST(test_createRequestString_playlistItemsContentDetails_simple);
